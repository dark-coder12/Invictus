      ...
      <div class="flex flex-col lg:flex-row">
        <div class="w-full lg:w-1/2">
          ...
          <p class="mb-8 text-justify italic font-thin pr-4">
            A React MCQ certification is a valuable credential for web
            developers who want to advance their careers front-end development.
            By obtaining this certification, developers can demonstrate their
            proficiency in React and their ability to create efficient and
            effective user interfaces. This certification can enhance their
            credibility and make them stand out.
          </p>
