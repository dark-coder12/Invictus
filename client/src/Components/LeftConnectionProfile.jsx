...
const LeftConnectionproject = ({imgUrl , name , username , bio , email}) => {
    return (
        <div className="flex flex-col text-white p-4">
          ...
          <button className="mt-6 bg-[#3A0303] text-white rounded-md">Follow</button>
          <button className="mt-6 bg-[#3A0303] text-white rounded-md">Unfollow</button>
        </div>
    )
}
