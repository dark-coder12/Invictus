  ...
  const questions = [
    {
      ...
      options: [
        ...
        "A language for building mobile apps",
      ],
    ...
    },
    {
      ...
      options: [
        ...
        "Functions that return React elements",
        "Both of the above",
      ],
    ...
    },
    {
      ...
      options: [
        ...
        "An abbreviation for JavaScript XML",
      ],
    ...
    },
    {
      ...
      options: [
        "A JavaScript object that stores a component's data",
        "A way to render a component on the server",
        "A method for updating the DOM",
      ],
    ...
    },
    {
      ...
      options: [
        ...
        "Props are managed within a component, while state is passed down from a parent component",
      ],
      answer:
        "State is managed within a component, while props are passed down from a parent component",
    },
    {
      ...
      options: [
        "A way to manage client-side routing in a single-page application",
        "A server-side rendering tool",
        "A method for styling components",
      ],
      answer:
    ...
    },
    {
      ...
      options: [
        "A way to use state and other React features without writing classes",
          ...
          <div class="pl-[5%] fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-black rounded-lg p-8 text-white text-center">
              ...
              <button
                ...
                onClick={() => console.log("Calculate Score")}
              >
                Calculate Score
              </button>
            </div>
